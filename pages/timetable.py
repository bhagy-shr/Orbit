...
# Page setup
st.set_page_config(
    page_title="Timetable & Attendance",
    page_icon="○",
    layout="wide"
)
...
with tab_attendance:
    ...
    if not subjects:
        ...
        with col_bunk:
            ...
            st.markdown("<p style='color: #94a3b8; font-size: 0.9rem; margin-top: -5px; margin-bottom: 15px;'>Calculate safe bunks based on your schedule and attendance target.</p>", unsafe_allow_html=True)
            ...
            if total_classes > 0:
                ...
                st.write(f"Current stats: **{attended_classes}** attended out of **{total_classes}** classes (**{pct:.1f}%**)")
        ...
        for idx, subj in enumerate(subjects):
            ...
            subj_attended = cursor.fetchone()[0]
            conn.close()
